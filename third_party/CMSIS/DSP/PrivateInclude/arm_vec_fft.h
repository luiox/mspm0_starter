...
#    define MVE_CMPLX_MULT_FX_AxB(A, B) \
        vqdmladhxq(vqdmlsdhq((__typeof(A))vuninitializedq_s32(), A, B), A, B);
#    define MVE_CMPLX_MULT_FX_AxConjB(A, B) \
        vqdmladhq(vqdmlsdhxq((__typeof(A))vuninitializedq_s32(), A, B), A, B);
