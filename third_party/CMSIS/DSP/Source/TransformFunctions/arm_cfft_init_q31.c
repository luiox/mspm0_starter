...
#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        defined(ARM_TABLE_BITREVIDX_FXT_1024) || defined(ARM_TABLE_BITREVIDX_FXT_2048)
    case 1024U:
...
#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        defined(ARM_TABLE_BITREVIDX_FXT_256) || defined(ARM_TABLE_BITREVIDX_FXT_512)
    case 256U:
...
#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        defined(ARM_TABLE_BITREVIDX_FXT_64) || defined(ARM_TABLE_BITREVIDX_FXT_128)
    case 64U:
...
#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        defined(ARM_TABLE_BITREVIDX_FXT_16) || defined(ARM_TABLE_BITREVIDX_FXT_32)
    case 16U:
...
arm_status arm_cfft_init_q31(arm_cfft_instance_q31* S, uint16_t fftLen)
{
    ...
    switch (S->fftLen) {
#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        (defined(ARM_TABLE_TWIDDLECOEF_Q31_4096) && defined(ARM_TABLE_BITREVIDX_FLT_4096))
        /*  Initializations of structure parameters for 4096 point FFT */
    case 4096U:
        /*  Initialise the bit reversal table modifier */
        FFTINIT(q31, 4096);
...
#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        (defined(ARM_TABLE_TWIDDLECOEF_Q31_2048) && defined(ARM_TABLE_BITREVIDX_FLT_2048))
        /*  Initializations of structure parameters for 2048 point FFT */
    case 2048U:
        /*  Initialise the bit reversal table modifier */
        FFTINIT(q31, 2048);
...
#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        (defined(ARM_TABLE_TWIDDLECOEF_Q31_1024) && defined(ARM_TABLE_BITREVIDX_FLT_1024))
        /*  Initializations of structure parameters for 1024 point FFT */
    case 1024U:
        /*  Initialise the bit reversal table modifier */
        FFTINIT(q31, 1024);
...
#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        (defined(ARM_TABLE_TWIDDLECOEF_Q31_512) && defined(ARM_TABLE_BITREVIDX_FLT_512))
        /*  Initializations of structure parameters for 512 point FFT */
    case 512U:
        /*  Initialise the bit reversal table modifier */
        FFTINIT(q31, 512);
...
#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        (defined(ARM_TABLE_TWIDDLECOEF_Q31_256) && defined(ARM_TABLE_BITREVIDX_FLT_256))
    case 256U: FFTINIT(q31, 256); break;
#    endif

#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        (defined(ARM_TABLE_TWIDDLECOEF_Q31_128) && defined(ARM_TABLE_BITREVIDX_FLT_128))
    case 128U: FFTINIT(q31, 128); break;
#    endif

#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        (defined(ARM_TABLE_TWIDDLECOEF_Q31_64) && defined(ARM_TABLE_BITREVIDX_FLT_64))
    case 64U: FFTINIT(q31, 64); break;
#    endif

#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        (defined(ARM_TABLE_TWIDDLECOEF_Q31_32) && defined(ARM_TABLE_BITREVIDX_FLT_32))
    case 32U: FFTINIT(q31, 32); break;
#    endif

#    if !defined(ARM_DSP_CONFIG_TABLES) || defined(ARM_ALL_FFT_TABLES) || \
        (defined(ARM_TABLE_TWIDDLECOEF_Q31_16) && defined(ARM_TABLE_BITREVIDX_FLT_16))
    case 16U:
        /*  Initializations of structure parameters for 16 point FFT */
        FFTINIT(q31, 16);
        break;
