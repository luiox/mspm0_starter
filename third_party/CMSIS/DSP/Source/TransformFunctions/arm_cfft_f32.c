...
static void arm_bitreversal_f32_inpl_mve(uint32_t* pSrc, const uint16_t bitRevLen,
                                          ...
                                          uint32_t fftLen)
{
    ...
    uint32_t              stage      = 0;
    int32_t               iter       = 1;
    static const uint32_t strides[4] = {(0 - 16) * sizeof(q31_t*),
                                        (1 - 16) * sizeof(q31_t*),
                                        (8 - 16) * sizeof(q31_t*),
                                        (9 - 16) * sizeof(q31_t*)};
    ...
    if (ifftFlag == 1U) {
        ...
        case 4096:
            _arm_radix4_butterfly_inverse_f32_mve(
                S, pSrc, fftLen, arm_inverse_fft_length_f32(S->fftLen));
            break;
