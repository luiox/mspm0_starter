                             ...
                             uint32_t bitReverseFlag)
{
    ...
    case 8192U: S->twidCoefRModifier = 1U;
...
#    endif
    ...
    case 4096U: S->twidCoefRModifier = 2U;
...
#    endif
    ...
    case 2048U: S->twidCoefRModifier = 4U;
...
#    endif
    ...
    case 1024U: S->twidCoefRModifier = 8U;
#    if defined(ARM_MATH_MVEI)
...
#    endif
    ...
    case 512U: S->twidCoefRModifier = 16U;
#    if defined(ARM_MATH_MVEI)
...
#    endif
    ...
    case 256U: S->twidCoefRModifier = 32U;
#    if defined(ARM_MATH_MVEI)
...
#    endif
    ...
    case 128U: S->twidCoefRModifier = 64U;
#    if defined(ARM_MATH_MVEI)
...
#    endif
    ...
    case 64U: S->twidCoefRModifier = 128U;
#    if defined(ARM_MATH_MVEI)
...
#    endif
    ...
    case 32U: S->twidCoefRModifier = 256U;
#    if defined(ARM_MATH_MVEI)
