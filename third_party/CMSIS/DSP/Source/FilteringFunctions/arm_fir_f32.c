...
static void arm_fir_f32_1_4_mve(const arm_fir_instance_f32* S, const float32_t* pSrc,
...
static void arm_fir_f32_5_8_mve(const arm_fir_instance_f32* S, const float32_t* pSrc,
                                float32_t* pDst, uint32_t blockSize)
{
    float32_t*       pState  = S->pState;  /* State pointer */
    const float32_t* pCoeffs = S->pCoeffs; /* Coefficient pointer */
