...
static char _acUpBufferTrace [BUFFER_SIZE_UP];
...
static SEGGER_RTT_CB _SEGGER_RTT = {
  ...
  {
    { "Terminal_log", &_acUpBuffer[0],   sizeof(_acUpBuffer),   0, 0, SEGGER_RTT_MODE_NO_BLOCK_SKIP },
    { "Terminal_trace", &_acUpBufferTrace[0],   sizeof(_acUpBufferTrace),   1, 0, SEGGER_RTT_MODE_NO_BLOCK_SKIP },
  },
